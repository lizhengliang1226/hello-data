...
public class KeyGenerator {
    ...
    public static final String COL_DEFAULT_VAL_PREFIX = "COL_DEF_VAL";
    ...
    public static String genColDefaultValKey(String datasourceId, String columnName) {
        return COL_DEFAULT_VAL_PREFIX + SEP + datasourceId + SEP + columnName;
    }
}